...
export default function hamburger() {
  ...
  return ( <div>
    ...
    {open && <div className="fixed absolute top-0 right-0 w-[65%] h-screen pt-4 pr-8 backdrop-blur-xl text-gray-700 bg-gradient-to-br from-purple-100/98 via-blue-100/98 to-orange-100/98">
